...
const UpdateCard = () => {
    ...
    const onSubmit = (data) => {
        const { average_cost, description, image,location,total_visit,tourist_spot,travel_time,
        } = data
        const allData = {average_cost, description, image, location,  total_visit, tourist_spot, travel_time, country, season}
        console.log(allData)
